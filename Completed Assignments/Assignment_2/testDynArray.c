...
int main(int argc, char* argv[]){
	...
	DynArr *dyn;
	dyn = createDynArr(2);
	int startsize=sizeDynArr(dyn);
	printf("\n\nTesting addDynArr...\n");
	printf("Size of array: %i", startsize);				//added to print size of array
	printf("\n");
	...
	addDynArr(dyn, 5);
	addDynArr(dyn, 6);
	if(sizeDynArr(dyn)-startsize!=5){
	printf("Resize FAIL\n");}
	else{printf("Resize PASS\n");}
	printf("Size of array: %i", sizeDynArr(dyn));				//added to print size of array
	printf("\n");
